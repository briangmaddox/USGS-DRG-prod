...
J. Moyers, MCMC		July, 1995      Incorrect use of function 'perror'.
					Changed to printf.
...
for (i=0;;i++)
      ...
      /* if (i >= 50) perror("Iteration failed to converge","IntMoll-forward"); */
      if (i >= 50) printf("Iteration failed to converge in IntMoll-forward.\n");
      }
theta /= 2.0;
